...
μGL renderbuffers are represented by the [`Renderbuffer`](https://ugl.lakuna.pw/classes/Renderbuffer.html) class.
...
μGL framebuffers are represented by the [`Framebuffer`](https://ugl.lakuna.pw/classes/Framebuffer.html) class. Attachments can be added with the [`attach`](https://ugl.lakuna.pw/classes/Framebuffer.html#attach) method.

```js
const framebuffer = new Framebuffer(gl);
framebuffer.attach(0, texture);
```
...
```js
const color = new Texture2d(gl);
color.format = TextureFormat.RGBA;
color.setMip(void 0, 0, void 0, [0, 0, 0x100, 0x100]);
color.minFilter = TextureFilter.NEAREST;
color.magFilter = TextureFilter.NEAREST;

const depth = new Renderbuffer(
	gl,
	RenderbufferFormat.DEPTH_COMPONENT24,
	0x100,
	0x100
...
const framebuffer = new Framebuffer(gl);
framebuffer.attach(0, color);
framebuffer.attach(FramebufferAttachment.DEPTH, depth);
```
...
μGL has corresponding [`drawBuffers`](https://ugl.lakuna.pw/classes/Framebuffer.html#drawbuffers) and [`readBuffer`](https://ugl.lakuna.pw/classes/Framebuffer.html#readbuffer) accessors to handle this functionality.
