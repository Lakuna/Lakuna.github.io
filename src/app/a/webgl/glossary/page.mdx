...
- [GPGPU](/a/webgl/gpgpu): general-purpose GPU; refers to using the GPU to do work other than rendering a scene.
...
- [Read buffer](/a/webgl/framebuffers): the buffer that will be used as the pixel source for subsequent read operations.
...
- [Transform feedback](/a/webgl/gpgpu): the process of capturing primitives generated by the vertex processing step (varyings) and recording data from those primitives into buffer objects.
