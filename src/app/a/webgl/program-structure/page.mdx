...
In μGL, resizing the viewport is done with the [`viewport`](https://ugl.lakuna.pw/classes/Context.html#viewport) accessor.
...
μGL is more explicit about the fact that this modifies the contents of the framebuffer, so clearing color buffers is done with the [`clear`](https://ugl.lakuna.pw/classes/Framebuffer.html#clear) method on the [`Framebuffer`](https://ugl.lakuna.pw/classes/Framebuffer.html). The default framebuffer object can be accessed via the [`fbo`](https://ugl.lakuna.pw/classes/Context.html#fbo) property. The clear color can be set via the [`clearColor`](https://ugl.lakuna.pw/classes/Context.html#clearcolor) accessor or by passing a color to `clear`.
